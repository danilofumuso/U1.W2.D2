...
const totalShoppingCart = 33.5;
const shippingCost = 10;

if (totalShoppingCart > 50) {
  console.log("Total Cost= ", totalShoppingCart);
} else {
  console.log("Total Cost= ", totalShoppingCart + shippingCost);
}
...
if (a > b && a > c && b > c) {
  console.log("1>13>0.5");
} else if (a < b && a > c && b > c) {
  console.log("13>1>0.5");
} else if (a < b && a < c && b > c) {
  console.log("13>0.5>1");
} else if (a < b && a < c && b < c) {
  console.log("0.5>13>1");
} else if (a > b && a > c && b < c) {
  console.log("1>0.5>13");
} else {
  console.log("0.5>1>13");
}
...
const valore = "31";
console.log("valore", typeof valore); //è una stringa
